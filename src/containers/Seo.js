...
const locales = {
  en: {
    description:
      'The personal website of Matthias Koch. Learn and level-up about React & JavaScript.',
  },
  fr: {
    description:
      'Le site personnel de Matthias Koch. Apprenez et devenez meilleur en React et JavaScript.',
  },
}
...
export function Seo({
  ...
  const title = customTitle || 'Matthias Koch'
